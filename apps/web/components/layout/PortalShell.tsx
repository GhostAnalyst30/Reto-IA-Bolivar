  ...
  return (
    <div className="flex min-h-screen">
      <aside className={cn(
            ...
            <Link
              ...
              className={cn(
                ...
                pathname === item.href || pathname.startsWith(item.href + '/')
                  ...
                  : 'text-zinc-400 hover:bg-brand-bg hover:text-white'
              )}
            >
              {item.label}
            </Link>
        ...
        <button onClick={logout} className="absolute bottom-4 left-4 flex items-center gap-2 text-sm text-zinc-500 hover:text-white">
